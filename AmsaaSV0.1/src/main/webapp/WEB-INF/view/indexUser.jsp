...
<script src="${pageContext.request.contextPath}/lib/amd/require.js"
	data-main="${pageContext.request.contextPath}/application/mainuser"></script>
						...
						<div class="row">
							<div class="span12">
								<ul class="nav nav-tabs">
									<li class="active"><a href="#peopleprofile" data-toggle="tab"><i
			...
			<div class="row">
				<div class="span12">
					...
					<sec:authorize access="hasRole('ROLE_USER')">
						<div class="tab-pane active" id="peopleprofile"></div>
