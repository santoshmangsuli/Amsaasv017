...
public class ManageServicePlanImpl implements ManageServicePlan
{
	...
	public String registerServicePlan(ServicePlan servicePlan)
	{
		return servicePlanRepository.createOrUpdate(servicePlan);
	}
	...
	public String updateServicePlanDetails(ServicePlan servicePlan)
	{
		ServicePlan srvcPlan = servicePlanRepository.findById(servicePlan.getSrvcPlanName());
		srvcPlan.updateServicePlanDetails(servicePlan.getSrvcPlanName(), servicePlan.getSrvcPlanCreatDate());
		return servicePlanRepository.createOrUpdate(srvcPlan);
	}
