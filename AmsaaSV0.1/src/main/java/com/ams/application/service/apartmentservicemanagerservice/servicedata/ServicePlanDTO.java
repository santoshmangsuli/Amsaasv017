package com.ams.application.service.apartmentservicemanagerservice.servicedata;

public class ServicePlanDTO
{
	private long	srvcPlanId;
	...
	public void setSrvcPlanId(long srvcPlanId)
	{
		this.srvcPlanId = srvcPlanId;
	}

	public long getSrvcPlanId()
	{
		return this.srvcPlanId;
	}
